import { RoadMarkingRenderer } from "./RoadMarkingRenderer.js";
export class RoadRenderer {
  constructor(context, projector) {
    this.context = context;
    this.projector = projector;
    this.markingRenderer = new RoadMarkingRenderer(context, projector);
  }
  renderGround() {
  ...
  renderIntersection(snapshot) {
    ...
    this.markingRenderer.renderLaneMarks();
    this.#renderCurbs();
  }
